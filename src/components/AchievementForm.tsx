...
interface AchievementFormProps {
    initialData?: AchievementFormData & { imagePreview?: string };
    onSubmit: (data: AchievementFormData, imageFile: File | null) => Promise<void>;
    isSubmitting: boolean;
    submitLabel?: string;
}

const AchievementForm = ({ initialData, onSubmit, isSubmitting, submitLabel = 'Submit Achievement' }: AchievementFormProps) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    rows={4}
                    placeholder="Details about the achievement, what was built, or why it matters..."
